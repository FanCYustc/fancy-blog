...
aliases: 
info: 
date: 2023-02-17-星期五 21:33
update: 
tags: [scientech/year2023,scientech/month02]
id: scientech20230217213335
...
*/ //这里给出以下几个版本：   
//1.课本“职工信息管理系统”调用的函数  
//按升序插入，创建链表时应按顺序输入数据（头插法降序，尾插法升序）  
//若要改为按降序插入，只需将函数中 < 改为 >    
//若要完成“管理系统”的多次插入，则应malloc申请新结点插入，而不是定义结构体变量，具体实现如下  
/*  
    case 2:  
        ...  
...
//销毁链表 Node* ListDistroy(Node *head){  
    Node *p = head, *temp;  
    while(p != NULL){  
        temp = p;  
        p = p->next;  
