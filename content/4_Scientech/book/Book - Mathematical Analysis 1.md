...
rate: 1
info: 寒假自主学习卓里奇数分英文版
date: 2022-12-25-星期日 21:21:50
update: 
tags: [book/year2022, book/month12,数学分析]
id: book20221225212150
---
---
...
## 2.1 The Axiom System and Some General Properties of the Setof Real Numbers 
### 2.1.1 Definition of the Set of Real Numbers 
### 2.1.2 Some General Algebraic Properties of Real Numbers
### 2.1.3 The Completeness Axiom and the Existence of a LeastUpper (or Greatest Lower) Bound of a Set of Numbers 

## 2.2 The Most Important Classes of Real Numbersand Computational Aspects of Operations with Real Numbers 
### 2.2.1 The Natural Numbers and the Principle of MathematicalInduction 
### 2.2.2 Rational and Irrational Numbers 
### 2.2.3 The Principle of Archimedes 
### 2.2.4 The Geometric Interpretation of the Set of Real Numbersand Computational Aspects of Operations with RealNumbers

## 2.3 Basic Lemmas Connected with the Completeness of the RealNumbers 
[[Wiki - 实数的完备性等价命题]]
...
### 3.1.3 Questions Involving the Existence of the Limitof a Sequence 
...
### 3.2.3 The General Definition of the Limit of a Function (Limitover a Base) 
...
### 5.1.3 The Tangent Line; Geometric Meaning of the Derivativeand Differential 
...
### 5.3.2 The Theorems of Lagrange and Cauchy on FiniteIncrements
...
## 5.5 Complex Numbers and the Connections Among the ElementaryFunctions 
### 5.5.1 Complex Numbers 
### 5.5.2 Convergence in C and Series with Complex Terms 
### 5.5.3 Euler’s Formula and the Connections Amongthe Elementary Functions .
### 5.5.4 Power Series Representation of a Function. Analyticity 
### 5.5.5 Algebraic Closedness of the Field C of Complex Numbers 

## 5.6 Some Examples of the Application of Differential Calculusin Problems of Natural Science 
...
# 6 Integration 
## 6.1 Definition of the Integral and Description of the Set of IntegrableFunctions
...
### 6.2.2 The Integral as an Additive Function of the Intervalof Integration 
...
### 6.3.3 Integration by Parts in the Definite Integral and Taylor’sFormula 
[[Wiki - 分部积分]]
...
### 46.4.5 Work and Energy

## 6.5 Improper Integrals 
### 6.5.1 Definition, Examples, and Basic Properties of ImproperIntegrals
...
## 7.1 The Space R^m and the Most Important Classes of Its Subsets 
### 7.1.1 The Set R^m and the Distance in It 
[[Wiki - 欧式空间向量的模]]
...
### 7.1.2 Open and Closed Sets in R^m
[[Wiki - 度量空间的开集闭集]]


### 7.1.3 Compact Sets in R^m
[[Wiki - n维空间上的列紧性]]
...
### 7.2.2 Continuity of a Function of Several Variables andProperties of Continuous Functions 
...
## 8.1 The Linear Structure on R^m
### 8.1.1 R^m as a Vector Space 

[[Wiki - n维数组空间]]

### 8.1.2 Linear Transformations L : R^m →R^n 

[[Wiki - 线性映射]]

### 8.1.3 The Norm in R^m
### 8.1.4 The Euclidean Structure on R^m

[[Scientech - 线性代数-欧几里得空间]]

## 8.2 The Differential of a Function of Several Variables 
### 8.2.1 Differentiability and the Differential of a Functionat a Point 

[[Wiki - 映射的微分]]

### 8.2.2 The Differential and Partial Derivatives of a Real-ValuedFunction 

[[Wiki - 偏导]]

### 8.2.3 Coordinate Representation of the Differentialof a Mapping. The Jacobi Matrix 

[[Wiki - 雅各比矩阵]]

### 8.2.4 Continuity, Partial Derivatives, and Differentiabilityof a Function at a Point 
...
## 8.4 The Basic Facts of Differential Calculus of Real-ValuedFunctions of Several Variables .
### 8.4.1 The Mean-Value Theorem
### 8.4.2 A Sufficient Condition for Differentiability of a Functionof Several Variables
### 8.4.3 Higher-Order Partial Derivatives .
### 8.4.4 Taylor’s Formula 
### 8.4.5 Extrema of Functions of Several Variables 
### 8.4.6 Some Geometric Images Connected with Functionsof Several Variables 
...
[[Wiki - 线性相关与偏导数]]
### 8.6.4 Local Resolution of a Diffeomorphism intoa Composition of Elementary Ones 
...
### 8.7.1 k-Dimensional Surfaces in R^n 
